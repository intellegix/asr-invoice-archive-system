    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card text-center">
          <FileText className="mx-auto h-8 w-8 text-primary-600 dark:text-primary-400 mb-3" />
        ...
        <div className="card text-center">
          <CheckCircle className="mx-auto h-8 w-8 text-green-600 dark:text-green-400 mb-3" />
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
        ...
        <div className="card text-center">
          <div className="mx-auto h-8 w-8 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mb-3">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400">Processing System</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
              {avgProcessingTime != null ? `${avgProcessingTime.toFixed(1)}s` : '--'}
            </div>
            <div className="text-sm text-gray-500 dark:text-gray-400">Average Processing</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{manualReviewRate}%</div>
            <div className="text-sm text-gray-500 dark:text-gray-400">Manual Review Rate</div>
          </div>
        </div>
      </div>
    </div>
